...
const secondarySkills = [
  ...
  { name: "Responsive Design", icon: <FaMobileAlt color="#3B82F6" className="w-16 h-16" />, description: "Designed layouts for desktop, tablet, and mobile." },
];
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center w-full max-w-4xl">
        ...
        {skillData && (
          ...
          >
            ...
            <p className={`${bodyFont.variable} text-gray-300 max-w-xl`}>
